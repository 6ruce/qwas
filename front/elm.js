...
Elm.Common.Tuple = Elm.Common.Tuple || {};
Elm.Common.Tuple.make = function (_elm) {
   "use strict";
   _elm.Common = _elm.Common || {};
   _elm.Common.Tuple = _elm.Common.Tuple || {};
   if (_elm.Common.Tuple.values)
...
Elm.Localization = Elm.Localization || {};
Elm.Localization.make = function (_elm) {
   "use strict";
   _elm.Localization = _elm.Localization || {};
   if (_elm.Localization.values)
   return _elm.Localization.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   _elm.Localization.values = {_op: _op
                              ,lc: lc};
   return _elm.Localization.values;
};
Elm.Maybe = Elm.Maybe || {};
...
Elm.Views.Login.make = function (_elm) {
   ...
   _elm.Views.Login = _elm.Views.Login || {};
   if (_elm.Views.Login.values)
   ...
   var centeredDiv = function (content) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("ui one column stackable center aligned page grid")]),
      _L.fromArray([A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("column five wide")]),
      _L.fromArray([$Html.h1(_L.fromArray([]))(_L.fromArray([$Html.text($Localization.lc("Qwas"))]))
                   ,content]))]));
   };
   var image = "https://m1.behance.net/rendition/modules/34310785/disp/bf4dadf086f46af6d7331132e8ae9b02.jpg";
   var emptyModel = {_: {}
                    ,login: ""
                    ,password: ""
                    ,validationErrors: {_: {}
   ...
   var LoginFormModel = F3(function (a,
   b,
   c) {
      return {_: {}
             ,login: a
   ...
   var UpdatePassword = function (a) {
      return {ctor: "UpdatePassword"
             ,_0: a};
   };
   var UpdateLogin = function (a) {
      return {ctor: "UpdateLogin"
             ,_0: a};
   };
   ...
   model) {
      return function () {
         ...
         var isLoginValid = $List.isEmpty(errors.login);
         var isPasswordValid = $List.isEmpty(errors.password);
         return A2($Html.form,
         _L.fromArray([$Html$Attributes.$class("ui form segment")]),
         _L.fromArray([A4($Widgets$Fields.validationTextField,
                      $Localization.lc("Login"),
                      model.login,
                      _L.fromArray([$Widgets$Fields.onInput(sendAction(UpdateLogin))]),
                      isLoginValid)
                      ,A4($Widgets$Fields.validationTextField,
                      $Localization.lc("Password"),
                      model.password,
...
Elm.Views = Elm.Views || {};
Elm.Views.MainPage = Elm.Views.MainPage || {};
Elm.Views.MainPage.make = function (_elm) {
   "use strict";
   _elm.Views = _elm.Views || {};
   _elm.Views.MainPage = _elm.Views.MainPage || {};
   if (_elm.Views.MainPage.values)
   return _elm.Views.MainPage.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Views.MainPage",
   $Html = Elm.Html.make(_elm),
   $Localization = Elm.Localization.make(_elm),
   $Widgets$Buttons = Elm.Widgets.Buttons.make(_elm);
   var view = A2($Widgets$Buttons.simpleButton,
   $Localization.lc("Test"),
   _L.fromArray([]));
   _elm.Views.MainPage.values = {_op: _op
                                ,view: view};
   return _elm.Views.MainPage.values;
};
...
Elm.Widgets.Buttons = Elm.Widgets.Buttons || {};
Elm.Widgets.Buttons.make = function (_elm) {
   "use strict";
   _elm.Widgets = _elm.Widgets || {};
   _elm.Widgets.Buttons = _elm.Widgets.Buttons || {};
   if (_elm.Widgets.Buttons.values)
   return _elm.Widgets.Buttons.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Widgets.Buttons",
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm);
   var simpleButton = F2(function (caption,
   additionalAttributes) {
      return A2($Html.div,
      $List.concat(_L.fromArray([_L.fromArray([$Html$Attributes.$class("ui button purple")])
                                ,additionalAttributes])),
      _L.fromArray([$Html.text(caption)]));
   });
   _elm.Widgets.Buttons.values = {_op: _op
                                 ,simpleButton: simpleButton};
   return _elm.Widgets.Buttons.values;
};
Elm.Widgets = Elm.Widgets || {};
Elm.Widgets.Fields = Elm.Widgets.Fields || {};
Elm.Widgets.Fields.make = function (_elm) {
   "use strict";
   _elm.Widgets = _elm.Widgets || {};
   _elm.Widgets.Fields = _elm.Widgets.Fields || {};
   if (_elm.Widgets.Fields.values)
   return _elm.Widgets.Fields.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Widgets.Fields",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   ...
   var errorMessages = function (errors) {
      return function () {
         ...
         var displayValue = $List.isEmpty(errors) ? "none" : "block";
         var display = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                            ,_0: "display"
                                                            ,_1: displayValue}]));
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("ui error message left aligned column")
                      ,display]),
   ...
   var textInput = F3(function (placeholder,
   value,
   additionalAttributes) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("ui input")]),
      _L.fromArray([A2($Html.input,
      $List.concat(_L.fromArray([_L.fromArray([$Html$Attributes.type$("text")
                                              ,$Html$Attributes.placeholder(placeholder)
                                              ,$Html$Attributes.value(value)])
                                ,additionalAttributes])),
      _L.fromArray([]))]));
   });
   var textField = F3(function (placeholder,
   value,
   additionalAttributes) {
      return function () {
         var input = A3(textInput,
         placeholder,
         value,
         additionalAttributes);
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("required field")]),
         _L.fromArray([input]));
      }();
   });
   var validationTextField = F4(function (placeholder,
   value,
   additionalAttributes,
   isValid) {
      return function () {
         ...
         _L.fromArray([$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                               ...
                                                               ,{ctor: "_Tuple2"
                                                                ,_0: "error"
                                                                ,_1: $Basics.not(isValid)}]))]),
         _L.fromArray([input]));
      }();
   });
   var onInput = function (message) {
      return A3($Html$Events.on,
      "input",
      $Html$Events.targetValue,
      message);
   };
   _elm.Widgets.Fields.values = {_op: _op
                                ,onInput: onInput
                                ,textInput: textInput
                                ,textField: textField
